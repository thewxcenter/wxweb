<?php
  ...
  $fullpath = '/var/www/wxcenter/httpdocs/dev/wxweb-master/';
  ...
  $fullurl = 'http://www.michiganwxsystem.net/dev/wxweb-master/';
  ...
  $mysql['loc_database'] = 'wxdata';
  $mysql['loc_dbuser'] = 'root';
  $mysql['loc_password'] = 'K@jslnitr0';
  $mysql['loc_host'] = '';
